...
import com.selenium.homePage.urbanLadder;
...
public class testCases {
	...
	public void popup() throws Exception {
		ExtentTest logger = report.createTest("Closing Popup", "Test 1");
	...
	public void bookshelves() throws Exception {
		ExtentTest logger = report.createTest("Open Bookshelves", "Test 2");
	...
	public void storage() throws Exception {
		ExtentTest logger = report.createTest("Select storage type", "Test 3");
	...
	public void slider() throws Exception {
		ExtentTest logger = report.createTest("Adjust slider", "Test 4");
	...
	public void checkbox() throws Exception {
		ExtentTest logger = report.createTest("Exclude - Checbox", "Test 5");
	...
	public void printItems() throws Exception {
		ExtentTest logger = report.createTest("Print first three items", "Test 6");
	...
	public void collections() throws Exception {
		ExtentTest logger = report.createTest("Collections", "Test 7");
	...
	public void printSubmenu() throws Exception {
		ExtentTest logger = report.createTest("Sub menu - New Arrivals", "Test 8");
	...
	public void giftCard() throws Exception {
		ExtentTest logger = report.createTest("Giftcards", "Test 9");
